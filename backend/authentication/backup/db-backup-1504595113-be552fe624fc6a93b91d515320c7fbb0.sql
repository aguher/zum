...
INSERT INTO tt_budget_expenses VALUES("36","393","1050.2","january","0","387");
...
CREATE TABLE `tt_budget_income` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=416 DEFAULT CHARSET=latin1 COLLATE=latin1_german1_ci;
...
INSERT INTO tt_budget_income VALUES("415","23.5","393","0","january");
...
INSERT INTO tt_budget_income VALUES("414","22","386","1","january");
...
INSERT INTO tt_company_report VALUES("1","406","9","1.5","2");
...
CREATE TABLE `tt_expenses_fixed_concept` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=521 DEFAULT CHARSET=latin1 COLLATE=latin1_german1_ci;
