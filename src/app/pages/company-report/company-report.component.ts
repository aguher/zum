...
@Component({ selector: 'app-company-report', templateUrl: './company-report.component.html', styleUrls: ['./company-report.component.scss'] })
      ...
      this
        ...
        .subscribe((response) => {
          if (response.error) {
            ...
            this.incomesFromDB = {
              budget: response.report.incomes_budget,
              real: response.report.incomes_real
            };
