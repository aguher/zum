...
@Component({selector: 'app-projects-new', templateUrl: './projects-new.component.html', styleUrls: ['./projects-new.component.scss']})
...
; // "<%= value %>"; */
  ...
  public lineChartData: Array<any> = [{ data: [], label: +this.hoy.getFullYear()-2 },{ data: [], label: +this.hoy.getFullYear()-1 }, { data: [], label: +this.hoy.getFullYear() }];
...
colorsHor = [
            ...
            response
              ...
              .forEach(element => {
                ...
                element.creation_date = this
                  ._common
                  .getFecha(new Date(element.creation_date));
                element.end_date = this
                  ._common
                  .getFecha(new Date(element.end_date));
              });
  ...
  calcularestadisticas(mensaje){
    this._api.getStadisticsCampaigns((this.filtroestado >= 3 ? 2 : this.filtroestado)).subscribe(response => {
      if (response !== null) {
        if (response.error) {
          this._auth.logout();
  ...
  recuperarfiltrosstorage(){
    this.filtronumero = (localStorage.getItem(this.user_id + 'PRYfiltronumero') ? localStorage.getItem(this.user_id + 'PRYfiltronumero') : '');
    this.filtroproyecto = (localStorage.getItem(this.user_id + 'PRYfiltroproyecto') ? localStorage.getItem(this.user_id + 'PRYfiltroproyecto') : '');
    this.filtrocliente = (localStorage.getItem(this.user_id + 'PRYfiltrocliente') ? localStorage.getItem(this.user_id + 'PRYfiltrocliente') : '');
    this.filtrofechainicio = (localStorage.getItem(this.user_id + 'PRYfiltrofechainicio') ? localStorage.getItem(this.user_id + 'PRYfiltrofechainicio') : '');
    this.filtropedido = (localStorage.getItem(this.user_id + 'PRYfiltropedido') ? localStorage.getItem(this.user_id + 'PRYfiltropedido') : '');
    this.filtroestado = (localStorage.getItem(this.user_id + 'PRYfiltroestado') ? localStorage.getItem(this.user_id + 'PRYfiltroestado') : "-1");
    this.filtroestadoanterior = (localStorage.getItem(this.user_id + 'PRYfiltroestadoanterior') ? localStorage.getItem(this.user_id + 'PRYfiltroestadoanterior') : '');
    this.filtrodesestimado = (localStorage.getItem(this.user_id + 'PRYfiltrodesestimado') ? localStorage.getItem(this.user_id + 'PRYfiltrodesestimado') : "-1");
    this.filtroingresosprevistos = (localStorage.getItem(this.user_id + 'PRYfiltroingresosprevistos') ? localStorage.getItem(this.user_id + 'PRYfiltroingresosprevistos') : '');
    this.filtroingresosreales = (localStorage.getItem(this.user_id + 'PRYfiltroingresosreales') ? localStorage.getItem(this.user_id + 'PRYfiltroingresosreales') : '');
    this.filtrogastosprevistos = (localStorage.getItem(this.user_id + 'PRYfiltrogastosprevistos') ? localStorage.getItem(this.user_id + 'PRYfiltrogastosprevistos') : '');
    this.filtrogastosreales = (localStorage.getItem(this.user_id + 'PRYfiltrogastosreales') ? localStorage.getItem(this.user_id + 'PRYfiltrogastosreales') : '');
    this.filtromargenprevistos = (localStorage.getItem(this.user_id + 'PRYfiltromargenprevistos') ? localStorage.getItem(this.user_id + 'PRYfiltromargenprevistos') : '');
    this.filtromargenreales = (localStorage.getItem(this.user_id + 'PRYfiltromargenreales') ? localStorage.getItem(this.user_id + 'PRYfiltromargenreales') : '');
  ...
  guardarfiltrosstorage(){
    ...
    localStorage.setItem(this.user_id + 'PRYfiltroproyecto',this.filtroproyecto);
    localStorage.setItem(this.user_id + 'PRYfiltrocliente',this.filtrocliente);
    localStorage.setItem(this.user_id + 'PRYfiltrofechainicio',this.filtrofechainicio);
    ...
    localStorage.setItem(this.user_id + 'PRYfiltroestadoanterior',this.filtroestadoanterior);
    localStorage.setItem(this.user_id + 'PRYfiltrodesestimado',this.filtrodesestimado);
    localStorage.setItem(this.user_id + 'PRYfiltroingresosprevistos',this.filtroingresosprevistos);
    localStorage.setItem(this.user_id + 'PRYfiltroingresosreales',this.filtroingresosreales);
    localStorage.setItem(this.user_id + 'PRYfiltrogastosprevistos',this.filtrogastosprevistos);
    localStorage.setItem(this.user_id + 'PRYfiltrogastosreales',this.filtrogastosreales);
    localStorage.setItem(this.user_id + 'PRYfiltromargenprevistos',this.filtromargenprevistos);
    localStorage.setItem(this.user_id + 'PRYfiltromargenreales',this.filtromargenreales);
    localStorage.setItem(this.user_id + 'PRYfiltroPtesFacturar',this.filtroPtesFacturar.toString());
    localStorage.setItem(this.user_id + 'PRYfiltroSinFactura',this.filtroSinFactura.toString());
  }
  ...
  filtrar(){
    ...
    let filtroproy:string = (this.filtroproyecto == undefined ? "" : this.filtroproyecto);
    let filtrocli:string = (this.filtrocliente == undefined ? "" : this.filtrocliente);
    let filtrofini:string = (this.filtrofechainicio == undefined ? "" : this.filtrofechainicio);
    ...
    let filtrodes:string = (this.filtrodesestimado == undefined ? "": this.filtrodesestimado);
    let filtroip:string = (this.filtroingresosprevistos == undefined ? "": this.filtroingresosprevistos);
    let filtroir:string = (this.filtroingresosreales == undefined ? "": this.filtroingresosreales);
    let filtrogp:string = (this.filtrogastosprevistos == undefined ? "": this.filtrogastosprevistos);
    let filtrogr:string = (this.filtrogastosreales == undefined ? "": this.filtrogastosreales);
    let filtromp:string = (this.filtromargenprevistos == undefined ? "": this.filtromargenprevistos);
    let filtromr:string = (this.filtromargenreales == undefined ? "": this.filtromargenreales);

    for (let i= 0; i < this.projects.length; i++){
       if (this._common.getCleanedString(this.projects[i].campaign_code).indexOf(this._common.getCleanedString(filtronum)) >= 0 &&
        this._common.getCleanedString(this.projects[i].campaign_name).indexOf(this._common.getCleanedString(filtroproy)) >= 0 &&
        this._common.getCleanedString(this.projects[i].customer).indexOf(this._common.getCleanedString(filtrocli)) >= 0 &&
        this._common.getCleanedString(this.projects[i].creation_date).indexOf(this._common.getCleanedString(filtrofini)) >= 0 &&
        this._common.getCleanedString(this.projects[i].ped_code).indexOf(this._common.getCleanedString(filtroped)) >= 0 &&
        this._common.getDecimals(this.projects[i].budget_income,2).indexOf(this._common.getCleanedString(filtroip)) >= 0 &&
        this._common.getDecimals(this.projects[i].real_income,2).indexOf(this._common.getCleanedString(filtroir)) >= 0 &&
        this._common.getDecimals(this.projects[i].budget_expenses,2).indexOf(this._common.getCleanedString(filtrogp)) >= 0 &&
        this._common.getDecimals(this.projects[i].real_expenses,2).indexOf(this._common.getCleanedString(filtrogr)) >= 0 &&
        this._common.getDecimals(this.projects[i].budget_income-this.projects[i].budget_expenses,2).indexOf(this._common.getCleanedString(filtromp)) >= 0 &&
        this._common.getDecimals(this.projects[i].real_income-this.projects[i].real_expenses,2).indexOf(this._common.getCleanedString(filtromr)) >= 0 &&
        (this._common.getCleanedString(this.projects[i].desestimado).indexOf(this._common.getCleanedString(filtrodes)) >= 0 || filtrodes == "-1") &&
        (this._common.getCleanedString(this.projects[i].id_status).indexOf(this._common.getCleanedString(filtroest)) >= 0 || filtroest == "-1")
        ){
          let pasafiltroptesfacturar = false;
          let pasafiltrosinfactura = false;

          if (!this.filtroPtesFacturar || isNull(this.projects[i].real_income) || Math.round(parseFloat(this.projects[i].real_income)) < Math.round(parseFloat(this.projects[i].budget_income ))){
            pasafiltroptesfacturar = true;
          }

          if (!this.filtroSinFactura || (this.projects[i].numfacturas == 0 && this.projects[i].id_status >= 2 && this.projects[i].budget_income != 0)){
  ...
  paginarysumar(){
    ...
    for (let i=0; i < this.projectsfiltrados.length;i++){
      ...
      if (isNull(this.projectsfiltrados[i].budget_expenses)) this.projectsfiltrados[i].budget_expenses = 0;
      if (isNull(this.projectsfiltrados[i].budget_income)) this.projectsfiltrados[i].budget_income = 0;      
      if (isNull(this.projectsfiltrados[i].real_expenses)) this.projectsfiltrados[i].real_expenses = 0;
      if (isNull(this.projectsfiltrados[i].real_income)) this.projectsfiltrados[i].real_income = 0;
      
      this.totalingresosprevistos += parseFloat(this.projectsfiltrados[i].budget_income);
      this.totalingresosreales += parseFloat(this.projectsfiltrados[i].real_income); 
      this.totalgastosprevistos += parseFloat(this.projectsfiltrados[i].budget_expenses);
      this.totalgastosreales += parseFloat(this.projectsfiltrados[i].real_expenses);                
    }
    

    this.numPage = +(localStorage.getItem(this.user_id + 'PRYpage') ? (localStorage.getItem(this.user_id + 'PRYpage')): 1);
...
/*         year: endDate[0],
  ...
  updateRows(response) {
    ...
    this.projectsfiltrados[indice].campaign_code = response.item[0].campaign_code;
    this.projectsfiltrados[indice].ped_code = response.item[0].ped_code;    
    this.projectsfiltrados[indice].campaign_name = response.item[0].campaign_name;
    ...
    this.projectsfiltrados[indice].security_level = response.item[0].security_level;
    this.projectsfiltrados[indice].creation_date_no_parsed = response.item[0].creation_date;
    this.projectsfiltrados[indice].end_date_no_parsed = response.item[0].end_date;
    this.projectsfiltrados[indice].creation_date = this
      ._common
      .getFecha(new Date(response.item[0].creation_date));
    this.projectsfiltrados[indice].end_date = this
      ._common
      .getFecha(new Date(response.item[0].end_date));
  ...
  createCampaign(proy=null) {
    ...
    if (proy == null){
      ...
      this.cabeceraNuevoProyecto = 'CLONAR ' + (proy.id_status == 1 ? 'PRESUPUESTO' : 'PEDIDO');      
  ...
  addCampaign() {
    ...
    if (!dataSelected) {
      ...
      if (this.bPermisoAnyadir && true ){//no hago esa validación que no funciona en los ipad
            ...
            if (response.status === 'ok') {
              if (this.proyectoorigen){
                ...
                this._api.clonarPresupuesto(body).subscribe(response => {
                   if (response.status === 'ok') {
                    this.projects[0].budget_income = this.proyectoorigen.budget_income;
                    this.projects[0].budget_expenses = this.proyectoorigen.budget_expenses;
                    this.filtrar();
                  }
                }) 
              }
              ...
              this
                ._notification
                .success('¡Éxito!', 'Se ha añadido el presupuesto/pedido');
            } else {
              this
                ._notification
...
/*         this
  ...
  updateApi() {
    ...
    //if (this.checkDates(this.selectedCampaign.creation_date_model, this.selectedCampaign.end_date_model)) {
      ...
      body += `&id_customer=${this.cambioCliente(this.selectedCampaign.customer)}`;
...
/*     } else {
        ...
        response
          ...
          .forEach((element) => {
            this
              ...
              if (this.selectedCampaign) this.selectedCampaign.customer = clientenuevo;              
          });
      }
  ...
  parseDesestimado(response,tipo) {
    if (response.status === 'ok') {
      ...
      this
        ._notification
        .success('¡Éxito!', 'Se ha actualizado el ' + tipo);
        this.refresh();
    } else {
      this.displayDialogDesestimar = false;
      this
...
/*               Finalizado: element.end_date, */
              ...
              'Ingresos Presupuesto': this._common.getNumber(this._common.getDecimals(values[element.id].estimated.incomes,2)),
              'Facturado': this._common.getNumber(this._common.getDecimals(values[element.id].real.incomes,2)), 
              'Coste Presupuesto': this._common.getNumber(this._common.getDecimals(values[element.id].estimated.expenses,2)),
              'Coste Real': this._common.getNumber(this._common.getDecimals(values[element.id].real.expenses,2)),
              'Beneficio Presupuesto': this._common.getNumber(this._common.getDecimals(values[element.id].estimated.profit,2)),
              'Beneficio Real': this._common.getNumber(this._common.getDecimals(values[element.id].real.profit,2))
            });
          }else{
            exportData.push(
              {
