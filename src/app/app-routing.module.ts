...
const appRoutes: Routes = [
  ...
  {
    path: "informe-empresa",
    component: CompanyReportNewComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "informe-empresa-old",
  ...
  {
    path: "informe-proyectos-estado",
    component: ProjectReportStatusComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "costes-fijos",
    component: FixedCostNewComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "costes-fijos-old",
  ...
  {
    path: "factura/:id",
    component: BillingBreakdownComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "proyectos-old",
  ...
  },
  {
    ...
    component: ProjectsSupervisorComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "presupuestos",
  ...
  {
    path: "presupuesto/:id",
    component: BudgetResumeComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "proyecto/:id",
    component: BreakdownResumeComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "desglose/:id",
  ...
  {
    path: "resumen/:id",
    component: SummaryProjectsComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "configuracion",
  ...
  {
    path: "conceptos-fijos",
    component: FixedConceptComponent,
    canActivate: [AuthGuard],
  },
  {
  ...
  {
    path: "subconceptos-standard",
    component: SubconceptStandardComponent,
    canActivate: [AuthGuard],
  },
