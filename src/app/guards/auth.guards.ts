...
export class AuthGuard implements CanActivate {
    ...
    constructor(private router: Router, private tokenService: TokenService, private auth: AuthenticationService) { }
    ...
    canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        switch (url) {
            case 'factura':
            case 'facturas':
                return ((roleUser === 3 || roleUser === 5) && localStorage.getItem('token'))
                    ? true
                    : this.userNotAllowed();
            ...
            case 'conceptos-variables':
                return ((roleUser === 3 || roleUser === 5) && localStorage.getItem('token'))
                    ...
                    : this.userNotAllowed();
            case 'costes-fijos':
                return ((roleUser === 3 || roleUser === 4) && localStorage.getItem('token'))
                    ? true
                    : this.userNotAllowed();
            ...
            case 'usuarios':
                return (roleUser === 3 && localStorage.getItem('token'))
                    ...
                    : this.userNotAllowed();
            case 'clientes': 
                return ((roleUser === 3 || roleUser === 5 || roleUser === 9 || roleUser === 10 || roleUser === 11) && localStorage.getItem('token'))
                    ? true
                    : this.userNotAllowed();     
            case 'equipos':
                return ((roleUser === 3 || roleUser === 5) && localStorage.getItem('token'))
            ...
            case 'subconceptos-standard':
                return ((roleUser === 3 || roleUser === 5 || roleUser === 6 || roleUser === 9 || roleUser === 10 || roleUser === 11) && localStorage.getItem('token'))
                    ? true
                    : this.userNotAllowed();
            case 'almacen':
            return ((roleUser === 3 || roleUser === 5 || roleUser === 6 || roleUser === 9 || roleUser === 10 || roleUser === 11) && localStorage.getItem('token'))
